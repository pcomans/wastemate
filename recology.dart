// Source: https://www.recology.com/recology-san-francisco/sorting-guides-and-signage/

List<Map<String, dynamic>> compost = [
  {
  ...
  },
  {
    ...
    "desc": "Plastic and cutlery clearly labeled “Compostable”",
  },
  {
    "terms": [
      "(green stripe or sticker to allow for easy identification)",
    ],
    "desc": "(green stripe or sticker to allow for easy identification)",
  },
  {
    "terms": [
...
List<Map<String, dynamic>> recycling = [
  {
    "terms": [
      "Aluminum cans",
    ],
  ...
  },
  {
    ...
    "desc": "CD’s, DVD’s, CDROM & Cases (remove paper insert)",
  },
  {
    "terms": [
      "Coffee cup lids",
